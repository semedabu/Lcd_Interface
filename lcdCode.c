...
# define CONFIG_RB9_AS_DIG_OUTPUT() _TRISB9 =0
...
# define CONFIG_RB5_AS_DIG_INPUT() _TRISB5 =1
# define CONFIG_RB6_AS_DIG_INPUT() _TRISB6 =1
# define CONFIG_RB7_AS_DIG_INPUT() _TRISB7 =1
# define CONFIG_RB8_AS_DIG_INPUT() _TRISB8 =1

# define CONFIG_RB5_AS_DIG_OUTPUT() _TRISB5 =0
# define CONFIG_RB6_AS_DIG_OUTPUT() _TRISB6 =0
# define CONFIG_RB7_AS_DIG_OUTPUT() _TRISB7 =0
# define CONFIG_RB8_AS_DIG_OUTPUT() _TRISB8 =0
